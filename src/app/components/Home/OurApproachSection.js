    ...
    <div className="px-4 md:px-8 lg:px-[72px] pt-20 pb-11 bg-white">
      ...
      <div className="m-0 grid grid-cols-1 xl:grid-cols-2 gap-y-10 gap-x-8">
        <div className="">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-10">
            <div className="w-full p-4 rounded-2xl border-[#C2C6D4] border-[1px] flex justify-center items-start shadow drop-shadow-sm translate-left">
              ...
              <div className="w-4/5 ps-2 flex flex-col gap-2">
                ...
                <p className="text-[#424752] text-sm leading-6">
                  We conduct a thorough assessment of your current compliance
            ...
            <div className="w-full p-4 rounded-2xl border-[#C2C6D4] border-[1px] flex justify-center items-start shadow drop-shadow-sm translate-left">
              <div className="w-1/5 h-full">
                <img src="/planning.svg" alt="Planning" className="size-14" />
              </div>
              <div className="w-4/5 ps-2 flex flex-col gap-2">
                <h3 className="h-6 font-medium text-xl text-[#191C21]">
                  Planning
                ...
                <p className="text-[#424752] text-sm leading-6">
                  We develop a customized compliance plan tailored to your
                  specific industry, size, and risk profile.
                </p>
              </div>
            </div>
            ...
            <div className="w-full p-4 rounded-2xl border-[#C2C6D4] border-[1px] flex justify-center items-start shadow drop-shadow-sm translate-left">
              ...
              <div className="w-4/5 ps-2 flex flex-col gap-2">
                ...
                <p className="text-[#424752] text-sm leading-6">
                  We implement the compliance plan, providing guidance,
                  training, and ongoing support to ensure successful
                  integration.
                </p>
              </div>
            </div>
      ...
      <div className="m-0 pt-20 grid grid-cols-1 xl:grid-cols-2 gap-y-10 gap-x-8">
        <div className="">
          ...
          <p className="text-base font-normal text-[#424752] leading-10 mt-10 block-animation">
            'CAABScore' gain valuable insights into your compliance performance
            through comprehensive data visualization and reporting tools.
            Therefore, the 'CAABScore' shall used by the stakeholders to rate
            your corporate compliance attitudes and commitment to Corporate
