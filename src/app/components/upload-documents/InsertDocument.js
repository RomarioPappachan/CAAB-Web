...
function InsertDocument({ department, setIsInsertDocumentOpen }) {
  ...
  return (
    <div className="ps-8 py-6 border-b-[1px] border-[#C2C6D4] flex flex-col lg:flex-row gap-6 relative">
      {/* <span className="absolute top-6 left-0">1{")"}</span> */}
      <div className="w-full lg:w-2/3 xl:w-3/4 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="flex flex-col">
          ...
          <input
            type="text"
            className="sm:col-span-2 h-10 px-3 text-sm leading-6 font-normal text-black bg-white rounded-lg border-[1px] border-[#707784] outline-none focus:border-2 focus:border-[#003E82] placeholder:text-[#404753]"
        ...
        <div className="flex flex-col">
          <label className="text-xs text-[#404753]">Licence No</label>
          <input
            type="text"
            className="h-10 px-3 text-sm leading-6 font-normal text-black bg-white rounded-lg border-[1px] border-[#707784] outline-none focus:border-2 focus:border-[#003E82] placeholder:text-[#404753]"
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className="row-start-3 h-10 px-3 text-sm leading-6 font-normal text-black bg-white rounded-lg border-[1px] border-[#707784] outline-none focus:border-2 focus:border-[#003E82] placeholder:text-[#404753]"
      ...
      <div className="w-full lg:w-1/3 xl:w-1/4 flex flex-col sm:flex-row gap-6 relative pb-14 sm:pb-0">
        ...
        >
          {inputData.documentLink ? (
            ...
            <span className="w-full h-full p-4 flex flex-col justify-center items-center gap-2 bg-[#D9D9D9]">
              <span>
                <MdOutlineFileUpload className="text-2xl text-[#424752]" />
              </span>
              <span className="text-sm text-[#424752] text-wrap text-center">
                Upload Document
              </span>
            </span>
          )}
      ...
      <button
        className="absolute -bottom-20 md:w-64 h-10 px-4 text-sm font-semibold leading-6 text-white rounded-lg bg-[#74CE3A] border-[1px] border-[#BFCAB3] hover:bg-[#75ce3ae1]"
