          ...
          <div className='pt-8 flex flex-col lg:flex-row gap-6'>
            <div className='w-full lg:w-1/2'>
              ...
              >
                ...
                <button 
                  type="submit"
                  className='mt-2 px-6 py-4 h-[4.5rem] rounded-2xl text-base font-semibold leading-6 text-white bg-[#2F6C00]'
                >SEND NOW</button>
              </form>
            </div>
              ...
              <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className='p-6 bg-[#CBDBFF] rounded-2xl flex flex-col justify-center items-center gap-y-2 drop-shadow-md'>
                    ...
                    <div className='flex flex-col items-center  gap-y-4'>
                      <p className='text-center text-base font-semibold leading-6 text-[#727783]'>Phone Number</p>
                      <p className='text-center text-base font-normal leading-6 text-[#191C21]'>+91 7736634226</p>
                    </div>
                </div>
                ...
                <div className='p-6 bg-[#CBDBFF] rounded-2xl flex flex-col justify-center items-center gap-y-2 drop-shadow-md'>
                    ...
                    <div className='flex flex-col items-center  gap-y-4'>
                      <p className='text-center text-base font-semibold leading-6 text-[#727783]'>Email Address</p>
                      <p className='text-center text-base font-normal leading-6 text-[#191C21]'>info@caabscore.com</p>
                    </div>
                </div>
                ...
                <div className='sm:col-span-2 p-6 bg-[#CBDBFF] rounded-2xl flex flex-col justify-center items-center gap-y-2 drop-shadow-md'>
                    ...
                    <div className='flex flex-col items-center gap-y-4'>
                      <p className='text-center text-base font-semibold leading-6 text-[#727783]'>Office Address</p>
                      <p className='text-center text-base font-normal leading-6 text-[#191C21]'>
                        <span>Ground Floor, Raiban Shopping Complex,</span><br />
                        <span>Palace Road, Alappuzha</span><br />
